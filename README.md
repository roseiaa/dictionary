This is a dictionary app made using Next.js and Tailwind. It uses Typescript to communicate with a dictionary and thesaurus API to extract information based on a word that the user inputs.
